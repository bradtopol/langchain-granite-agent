#!/usr/bin/env python3
"""
Data Models for NemoClaw Orchestration
...
class OrchestrationResult:
    ...
    def summary(self) -> str:
        """Get the summarizer's output"""
        result = self.context.get_result("summarizer")
        return result.output if result else ""
    
    @property
    def analysis(self) -> str:
        """Get the analyzer's output"""
        result = self.context.get_result("analyzer")
        return result.output if result else ""
